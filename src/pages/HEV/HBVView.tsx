                    ...
                    >
                        ...
                        <div className="mt-8 pt-4 border-t border-slate-300">
                             ...
                             <div className="grid grid-cols-2 gap-12 text-sm">
                                 <div>
                                     <div className="font-bold text-blue-900 mb-3 border-b border-blue-100 pb-1">AUTHORIZED BY:</div>
                                     <div className="space-y-3">
                                         <div className="grid grid-cols-[100px_1fr] gap-2">
                                             <span className="font-semibold text-slate-700">Officer Name:</span>
                                             <span>Dr. {data.createdBy || 'System Admin'}</span>
                                         </div>
                                          <div className="grid grid-cols-[100px_1fr] gap-2">
                                 ...
                                 <div>
                                      <div className="font-bold text-blue-900 mb-3 border-b border-blue-100 pb-1">SYSTEM DETAILS</div>
                                     <div className="space-y-3">
                                         <div className="grid grid-cols-[100px_1fr] gap-2">
