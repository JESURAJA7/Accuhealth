...
const HEVView: React.FC = () => {
    const { id } = useParams();
    const navigate = useNavigate();
    const [data, setData] = useState<HEVNotification | null>(null);
        ...
        const fetchData = async () => {
            try {
                ...
                if (response.ok) {
                    ...
                    toast.error('Failed to fetch HEV notification');
                }
            } catch (error) {
    ...
    const handleDownloadPDF = async () => {
        ...
        try {
            ...
            pdf.save(`HEV-Notification-${data.patientId || 'report'}.pdf`);
                    ...
                    >
                        ...
                        <div className="text-center mb-8">
                            <h1 className="text-2xl font-bold text-slate-800 uppercase tracking-wide mb-2">
                                Hepatitis E (HEV) Notification Report
                            </h1>
                        ...
                        <div className="mb-6 space-y-1.5 border-b border-slate-200 pb-4">
                            ...
                            <div className="grid grid-cols-[160px_1fr] gap-2">
                             ...
                             <div className="grid grid-cols-[160px_1fr] gap-2">
                                ...
                                <span>{data.id ? `HEV-${new Date().getFullYear()}-${data.id.toString().padStart(4, '0')}` : '-'}</span>
                            </div>
                        </div>
                            ...
                            <div>
                                ...
                                <div className="border border-slate-300 mb-4">
                                    <div className="grid grid-cols-2 border-b border-slate-300">
                                        <div className="bg-slate-100 p-2 font-bold text-slate-700 border-r border-slate-300">HEV IgM</div>
                                        <div className="p-2">{data.labResult || 'Positive'}</div>
                                    </div>
                                    <div className="grid grid-cols-2">
                                        <div className="bg-slate-100 p-2 font-bold text-slate-700 border-r border-slate-300">HEV RNA PCR</div>
                                        <div className="p-2">Detected</div>
                                    </div>
                                </div>
                            ...
                            <div>
                                ...
                                <div className="border border-slate-300 p-3">
                                    ...
                                    <p className="text-sm italic text-slate-700">
                                        {data.remarks || 'Patient diagnosed with Hepatitis E Infection. Supportive treatment initiated. Patient advised rest, hydration, and follow-up LFT monitoring.'}
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="mb-6 pb-4 border-b border-slate-300">
                            ...
                            <p className="text-sm text-slate-700">
                                This case has been notified as per Hepatitis E (HEV) disease surveillance and reporting guidelines.
                            </p>
                        </div>
