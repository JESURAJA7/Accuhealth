...
const TBNotification: React.FC = () => {
  ...
  const [formData, setFormData] = useState<TBNotificationFormData>({
    governorate: '',
    wilayat: 'dgsg',
    institution: 'dfgh',
    reportingDate: '',
  ...
  const steps = [
    ...
    },
    {
      ...
      icon: Activity,
      description: 'Symptoms, History & Risk Factors'
    },
    {
      id: 'tests-results',
      title: 'Tests & Results',
      icon: TestTube,
      description: 'IGRA, Mantoux & HIV Tests'
    },
    {
      id: 'lab-investigation',
      title: 'Lab Investigation',
      icon: FileText,
      description: 'Lab Tests, Radiology & Drug Sensitivity'
    },
    {
      id: 'classification-outcome',
      title: 'Classification & Outcome',
      icon: Calendar,
      description: 'Final Classification, Outcome & Attachments'
    }
  ];
  ...
  const renderPatientInfo = () => (
    <div className="space-y-8">
      <div className="text-center mb-8">
        <h2 className="text-2xl font-bold text-slate-900 mb-2">TB Notification</h2>
  ...
  const renderTestsResults = () => (
    <div className="space-y-8">
      <div className="text-center mb-8">
        ...
        <p className="text-yellow-600">[IGRA, Mantoux & HIV Tests]</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden">
          <div className="bg-slate-50 px-6 py-4 border-b border-slate-200">
            <h6 className="text-base font-semibold text-slate-900">IGRA Test</h6>
          </div>
        ...
        <div className="bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden">
          <div className="bg-slate-50 px-6 py-4 border-b border-slate-200">
            <h6 className="text-base font-semibold text-slate-900">HIV Test</h6>
          </div>
          <div className="p-6 space-y-4">
            <div className="space-y-2">
              <label className="block text-sm font-medium text-slate-700">Date</label>
  ...
  const renderLabInvestigation = () => (
    <div className="space-y-8">
      <div className="text-center mb-8">
        ...
        <p className="text-yellow-600">[Lab Tests, Radiology & Drug Sensitivity]</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden">
          <div className="bg-slate-50 px-6 py-4 border-b border-slate-200 flex justify-between items-center">
            <h6 className="text-base font-semibold text-slate-900">Drug Sensitivity Test</h6>
            <div className="flex space-x-2">
              <button type="button" className="px-3 py-1 bg-blue-500 text-white text-sm rounded hover:bg-blue-600">
                +
              </button>
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-slate-100">
                <tr>
                  <th className="px-4 py-3 text-left text-sm font-semibold text-slate-700">Drug Name</th>
                  <th className="px-4 py-3 text-left text-sm font-semibold text-slate-700">Date Reported</th>
                  <th className="px-4 py-3 text-left text-sm font-semibold text-slate-700">Result</th>
                  <th className="px-4 py-3 text-left text-sm font-semibold text-slate-700">Remarks</th>
                </tr>
              </thead>
  ...
  const renderClassificationOutcome = () => (
    <div className="space-y-8">
      <div className="text-center mb-8">
        <h2 className="text-2xl font-bold text-slate-900 mb-2">Classification & Outcome</h2>
        <p className="text-yellow-600">[Final Classification, Outcome & Attachments]</p>
      </div>

      <div className="bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden">
        <div className="bg-slate-50 px-6 py-4 border-b border-slate-200">
          <h5 className="text-lg font-semibold text-slate-900">Classification and Outcome</h5>
        </div>
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="space-y-2">
              ...
              >
                ...
                <option value="Treatment after loss to follow-up">Treatment after loss to follow-up</option>
                <option value="Other previously treated">Other previously treated</option>
                <option value="Unknown previous treatment history">Unknown previous treatment history</option>
              </select>
            </div>
      ...
      <div className="bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden">
        ...
        <div className="p-6">
          <FileUpload
            cloudName={import.meta.env.VITE_CLOUDINARY_CLOUD_NAME || 'dczicfhcv'}
            uploadPreset={import.meta.env.VITE_CLOUDINARY_UPLOAD_PRESET || 'Accuhealth'}
            maxFiles={10}
            maxSizeMB={5}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-3">
              <p className="text-sm font-medium text-slate-700">
                Confirmed case of TB <span className="text-red-500">*</span>
              </p>
              <div className="flex space-x-4">
                <label className="flex items-center">
                  <input
                    ...
                    name="confirmedTB"
                    value="Yes"
                    checked={formData.confirmedTB === 'Yes'}
                    onChange={handleInputChange}
                    className="mr-2 text-blue-600 focus:ring-blue-500"
                    required
                  />
                ...
                <label className="flex items-center">
                  <input
                    ...
                    name="confirmedTB"
                    value="No"
                    checked={formData.confirmedTB === 'No'}
                    onChange={handleInputChange}
                    className="mr-2 text-blue-600 focus:ring-blue-500"
                  />
                  <span className="text-sm text-slate-700">No</span>
  ...
  const renderCurrentStep = () => {
    switch (currentStep) {
      ...
      case 4:
        return renderClassificationOutcome();
      default:
        return renderPatientInfo();
    }
  };
            ...
            <div className="flex space-x-3">
              {currentStep === steps.length - 1 ? (
                <>
                  ...
                  <button
                    type="button"
                    onClick={() => setFormData({} as TBNotificationFormData)}
