...
import VaccineManufacturerModal from '../../components/VaccineManufacturerModal';
...
const VaccineManufacturer: React.FC = () => {
  const [items, setItems] = useState<VaccineManufacturerData[]>([
    {
      id: 1,
      code: '001',
    ...
    },
    {
      id: 4,
      code: '004',
      name: 'Dubai Health Authority Supply',
      description: 'test',
      isActive: true
    },
    {
  ...
  const fetchItems = async () => {
    try {
      ...
      const response = await fetch(`${API_URL}/masters/vaccine-manufacturers`, {
        headers: {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
          <div className="flex items-center justify-between p-6 border-b border-gray-200">
            <h1 className="text-xl font-semibold text-gray-800">Vaccine Manufacturer</h1>
            <button
