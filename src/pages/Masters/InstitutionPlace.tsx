...
import InstitutionPlaceModal from '../../components/InstitutionPlaceModal';

interface InstitutionPlaceData {
    id: number;
    code: string;
    name: string;
    description: string;
...
const InstitutionPlace: React.FC = () => {
    ...
    const fetchItems = async () => {
        try {
            ...
            const response = await fetch(`${API_URL}/masters/institution-place`, {
                headers: {
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                    <div className="flex items-center justify-between p-6 border-b border-gray-200">
                        <h1 className="text-xl font-semibold text-gray-800">Instituition/Place of vaccination</h1>
                        <button
...
export default InstitutionPlace;
