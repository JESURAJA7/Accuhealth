...
import SiteOfInjectionModal from '../../components/SiteOfInjectionModal';

interface SiteOfInjectionData {
    id: number;
    code: string;
    name: string;
    description: string;
...
const SiteOfInjection: React.FC = () => {
    ...
    const fetchItems = async () => {
        try {
            ...
            const response = await fetch(`${API_URL}/masters/site-of-injections`, {
                headers: {
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                    <div className="flex items-center justify-between p-6 border-b border-gray-200">
                        <h1 className="text-xl font-semibold text-gray-800">Site of Injection</h1>
                        <button
...
export default SiteOfInjection;
