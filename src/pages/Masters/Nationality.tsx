...
const Nationality: React.FC = () => {
    const [items, setItems] = useState<NationalityData[]>([
        { id: 1, code: '01', nationality: 'Africa', isActive: true },
        { id: 2, code: '02', nationality: 'India', isActive: true },
        { id: 3, code: '03', nationality: 'America', isActive: true }
    ]);
    ...
    const fetchItems = async () => {
        try {
            ...
            const response = await fetch(`${API_URL}/masters/nationalities`, {
                headers: {
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                    <div className="flex items-center justify-between p-6 border-b border-gray-200">
                        <h1 className="text-xl font-semibold text-gray-800">Nationality</h1>
                        <button
                        ...
                        <table className="w-full">
                            <thead>
                                <tr className="bg-[#3b82f6] text-white">
                                    ...
                                    <th className="px-6 py-4 text-left text-sm font-medium border-r border-blue-400 last:border-r-0">Nationality</th>
