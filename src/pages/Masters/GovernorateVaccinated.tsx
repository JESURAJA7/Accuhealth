...
import GovernorateVaccinatedModal from '../../components/GovernorateVaccinatedModal';

interface GovernorateVaccinatedData {
    id: number;
    code: string;
    name: string;
    description: string;
...
const GovernorateVaccinated: React.FC = () => {
    const [items, setItems] = useState<GovernorateVaccinatedData[]>([
        {
            id: 1,
            code: '10272325',
    ...
    const fetchItems = async () => {
        try {
            ...
            const response = await fetch(`${API_URL}/masters/governorate-vaccinated`, {
                headers: {
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                    <div className="flex items-center justify-between p-6 border-b border-gray-200">
                        <h1 className="text-xl font-semibold text-gray-800">Governorate vaccinated</h1>
                        <button
...
export default GovernorateVaccinated;
